...
# PROGRESS MADE: Final two sections need completing, Clicking and Scoring.
...
class MyASGEGame(pyasge.ASGEGame):
    ...
    def initMenu(self) -> bool:
        ...
        self.menu_text.position = [100,100]  # Without this, the default is 0,0 (on-top of the screen boarder)
    ...
    def keyHandler(self, event: pyasge.KeyEvent) -> None:
        ...
        # testing button (R) to check if randomise system function is working
